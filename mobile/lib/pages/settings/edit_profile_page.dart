...
class _EditProfilePageState extends ConsumerState<EditProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    Map<String, Widget> textFieldMap = {
      'fname' : EditProfileTextField(
        name: 'First name',
      ...
      'discordID': EditProfileTextField(
        name: 'Discord ID',
    ...
    List<Widget> widgets = textFieldMap.values.toList();
